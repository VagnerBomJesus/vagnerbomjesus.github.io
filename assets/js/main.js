...
(function () {
  ...
  var translations = {
    en: {
      ...
      'pub.title': 'Publications & writing',
      'pub.p1': 'Beyond building software, I document and share what I learn. I write technical and scientific articles, publish academic work, and keep a record of the research behind my projects so that others can learn from it and build on it.',
      'pub.p2': 'The development of The Biomimicry Database is described in my academic dissertation and in related publications, covering the design of a multimodal knowledge-sharing platform, the VITA chatbot, and how biological strategies can be organised and made searchable for research and education. On Medium I write in a more accessible tone about software engineering, Flutter and Dart, information security and lessons learned while shipping real projects.',
      'pub.medium': 'Read on Medium',
      'pub.scholar': 'Google Scholar',
      'pub.thesis': 'Dissertation (PDF)',
    ...
    pt: {
      ...
      'pub.title': 'Publicações & escrita',
      'pub.p1': 'Para além de construir software, documento e partilho o que aprendo. Escrevo artigos técnicos e científicos, publico trabalho académico e mantenho um registo da investigação por detrás dos meus projetos, para que outros possam aprender com ele e construir a partir dele.',
      'pub.p2': 'O desenvolvimento da The Biomimicry Database está descrito na minha dissertação académica e em publicações relacionadas, abordando o desenho de uma plataforma multimodal de partilha de conhecimento, o chatbot VITA e a forma como as estratégias biológicas podem ser organizadas e tornadas pesquisáveis para investigação e ensino. No Medium escrevo num tom mais acessível sobre engenharia de software, Flutter e Dart, segurança da informação e lições aprendidas ao lançar projetos reais.',
      'pub.medium': 'Ler no Medium',
      'pub.scholar': 'Google Scholar',
      'pub.thesis': 'Dissertação (PDF)',
